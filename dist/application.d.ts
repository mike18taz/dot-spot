...
declare const ConnectingDotsApp_base: (new (...args: any[]) => {
    [x: string]: any;
    projectRoot: string;
    ...
    [x: string]: any;
    serviceProvider<S>(provider: import("@loopback/service-proxy").Class<import("@loopback/core").Provider<S>>, nameOrOptions?: string | import("@loopback/core").ServiceOptions | undefined): import("@loopback/boot").Binding<S>;
    component(component: import("@loopback/service-proxy").Class<unknown>, nameOrOptions?: string | import("@loopback/core").BindingFromClassOptions | undefined): void;
    ...
    component(component: import("@loopback/repository").Class<unknown>, nameOrOptions?: string | import("@loopback/core").BindingFromClassOptions | undefined): void;
...
export declare class ConnectingDotsApp extends ConnectingDotsApp_base {
